...
METHOD zif_bc_model~fill_checkbox_fields ##NEEDED.
* Redefine when you want a checkbox (you can have more than one but
* I have never had that requirement yet)
ENDMETHOD.


METHOD zif_bc_model~fill_editable_fields ##NEEDED.
...
METHOD zif_bc_model~fill_field_texts ##NEEDED.
* Redefine when you want to rename at least one field
ENDMETHOD.


METHOD zif_bc_model~fill_hidden_fields ##NEEDED.
* Redefine for reports with hidden fields
ENDMETHOD.


METHOD zif_bc_model~fill_hotspot_fields ##NEEDED.
...
* That usually involves dynamically changing the list header at run-time
  ...
  METHOD zif_bc_model~fill_sort_criteria ##NEEDED.
* Redefine when report has sort criteria (most do)
  ENDMETHOD.


METHOD zif_bc_model~fill_subtotal_fields ##NEEDED.
* Redefine for reports with subtotals (the majority)
ENDMETHOD.


METHOD zif_bc_model~fill_technical_fields ##NEEDED.
...
METHOD zif_bc_model~fill_user_commands ##NEEDED.
...
METHOD zif_bc_model~user_command ##NEEDED.
