interface ZIF_BC_MODEL
  ...
  methods FILL_EDITABLE_FIELDS default ignore .
  methods FILL_TECHNICAL_FIELDS default ignore .
  methods FILL_HIDDEN_FIELDS default ignore .
  methods FILL_HOTSPOT_FIELDS default ignore .
  methods FILL_SUBTOTAL_FIELDS default ignore .
  methods FILL_FIELD_TEXTS default ignore .
  methods FILL_CHECKBOX_FIELDS default ignore .
  methods FILL_SORT_CRITERIA default ignore .
  methods SET_EDIT_CONTROL_FIELD default ignore
    importing
      !ID_EDIT_CONTROL_FIELD type LVC_FNAME default 'CELLTAB' .
  methods FILL_LAYOUT_DATA default ignore
    importing
